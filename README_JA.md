...
```bash
curl -sSL https://raw.githubusercontent.com/qiuham/sub2api/main/deploy/install.sh | sudo bash
```
...
# アンインストール
curl -sSL https://raw.githubusercontent.com/qiuham/sub2api/main/deploy/install.sh | sudo bash -s -- uninstall -y
```
...
curl -sSL https://raw.githubusercontent.com/qiuham/sub2api/main/deploy/docker-deploy.sh | bash
...
```bash
# 1. リポジトリをクローン
git clone https://github.com/qiuham/sub2api.git
cd sub2api/deploy
...
<a href="https://star-history.dera.page/#qiuham/sub2api&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://star-history.dera.page/svg?repos=qiuham/sub2api&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://star-history.dera.page/svg?repos=qiuham/sub2api&type=Date" />
   <img alt="Star History Chart" src="https://star-history.dera.page/svg?repos=qiuham/sub2api&type=Date" />
 </picture>
</a>
