...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/qiuham/sub2api/main/deploy/install.sh | bash
#
...
Documentation=https://github.com/qiuham/sub2api
