...
services:
  sub2api:
    image: ghcr.io/qiuham/sub2api:latest
    ports:
      - "8080:8080"
    environment:
...
- [GitHub Repository](https://github.com/ghcr.io/qiuham/sub2api)
- [Documentation](https://github.com/ghcr.io/qiuham/sub2api#readme)
